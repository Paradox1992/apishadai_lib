...
public final class ApiRequest<T> implements rsc.Services.api.RequestModel {
    ...
    public <T> Response<T> send(String route, String method, Session session, Object body, Type responseType) {
        ...
        validateInputParameters(route, method, session.getVersion());
    ...
    private void validateInputParameters(String route, String method, String version) {
    ...
    private static String getKey(String key) {
        String url = UrlReader.get(key).trim();
        if (url.isEmpty()) {
