...
public final class Session extends ActionButton {
    ...
    private final List<SessionPermission> spermisos;
    ...
    public Session(
            ...
            @JsonProperty("spermisos") List<SessionPermission> spermisos
    ) {
        this.token = token;
        this.uname = uname;
        this.urol = urol;
    ...
    public Session() {
        ...
        this.stockid = 0;
        this.deviceid = 0;
        this.spermisos = Collections.emptyList();
    ...
    public List<SessionPermission> getPermissions() {
